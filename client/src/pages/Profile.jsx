  ...
  return (
    <Box>
      ...
      <Box mt={25}>
        <Flex gap={"xs"} align={"center"}>
          ...
          >
            <Flex gap={"xs"} onClick={() => setOpened((o) => !o)}>
              <Text c={"red"} fw={600}>
                {user?.phone_number ? "User Verified" : "Not Verified"}
              </Text>
              <ThemeIcon
                variant="outline"
                color="red"
        ...
        <Button size="compact-xs" fz={15} p={0} my={6} variant="transparent">
          Contact Info
        </Button>
      </Box>
      {!user?.phone_number && (
      ...
      <Box mt={25}>
        <Paper shadow="xl" p="sm" withBorder>
          <Flex justify={"center"} align={"center"} gap={"xl"}>
            ...
            <Box>
              <Text fw={500} size="md" c={"green.7"} order={4}>
                Active Bookings
              </Text>
              <Text ta={"center"}>0</Text>
            </Box>
